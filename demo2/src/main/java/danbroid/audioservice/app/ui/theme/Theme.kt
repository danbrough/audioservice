...
private val LightColorPalette = AudioDemoColours(
    brand = Shadow5,
...
private val DarkColorPalette = AudioDemoColours(
    brand = Shadow1,
...
class AudioDemoColours(
    ...
    fun update(other: AudioDemoColours) {
    ...
    fun copy(): AudioDemoColours = AudioDemoColours(
...
@Composable
fun ProvideBrewAppColours(
    colors: AudioDemoColours,
    content: @Composable () -> Unit
) {
...
private val LocalJetsnackColors = staticCompositionLocalOf<AudioDemoColours> {
    error("No JetsnackColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colors] in preference to [AudioDemoTheme.colors].
 */
fun debugColors(
    darkTheme: Boolean,
